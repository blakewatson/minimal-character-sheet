<template>
  <div>
    ...
    >
      ...
      >
        <label for="ac-field" class="block text-sm">{{ $t('AC') }}</label>
        <field
          :read-only="readOnly"
          :value="ac"
      ...
      <div
        class="border-light-foreground dark:border-dark-foreground border-t text-center whitespace-nowrap"
      >
        <label for="hp-field" class="block text-sm">{{ $t('HP') }}</label>
        <field
          :read-only="readOnly"
          :value="hp"
      ...
      >
        <label for="temp-hp-field" class="block text-sm">{{
          $t('Temp HP')
        }}</label>
        <field
          id="temp-hp-field"
      ...
      <div
        class="border-light-foreground dark:border-dark-foreground min-w-0 border-t text-center"
      >
        <label
          for="hit-die-field"
      ...
      <div
        class="border-light-foreground dark:border-dark-foreground border-t text-center"
      >
        <label for="speed-field" class="block text-sm">{{ $t('Speed') }}</label>
        <field
          :read-only="readOnly"
          :value="speed"
      ...
      <div
        class="border-light-foreground dark:border-dark-foreground flex min-w-0 flex-col items-center border-t text-center"
      >
        <span
          class="mb-1 block max-w-full truncate text-sm"
          :title="$t('Death saves')"
          >{{ $t('Death saves') }}</span
        >
    ...
    <div class="flex max-w-full flex-wrap justify-center gap-x-4">
      <span class="mb-1 inline-flex max-w-full flex-wrap items-baseline gap-1">
        <label for="characterConditions" class="small-label">{{
          $t('Conditions')
        }}</label>
        <field
          :placeholder="$t('None')"
