(function () {
  ...
  if (
    ...
    inputTextareaFont.value =
      localStorage.getItem('setting-textarea-font') || 'default';
  ...
  function setTextareaFont(val) {
    document
      .querySelector('html')
      .classList.toggle('textarea-font-sans-serif', val === 'sans-serif');
    document
      .querySelector('html')
      .classList.toggle('textarea-font-serif', val === 'serif');
