...
- [ ] **STORE-01**: Rewrite Vuex store as reactive() composable with exported state, computed refs, and plain functions
...
- [ ] **STORE-07**: Fix SpellList.vue computed property that generates random IDs (move to creation time)
- [ ] **STORE-08**: Update listMixin to use direct array assignment instead of Vue.set
